...
cadence_types = st.sidebar.multiselect("Cadence types", CADENCES, default=["I-IV-V-I", "I-V-I"])
enabled_notes = st.sidebar.multiselect("Notes to guess from", NOTES, default=NOTES)
...
if st.session_state.current_note:
    ...
    if guess:
        ...
        st.write("✅ Correct!" if is_correct else f"❌ Wrong! It was {st.session_state.current_note}")
        st.session_state.current_note = None
